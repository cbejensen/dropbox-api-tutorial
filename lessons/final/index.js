...
const dbxElem = document.querySelector(".js-dbx");
const rootPathForm = dbxElem.querySelector(".js-root-path__form");
const rootPathInput = dbxElem.querySelector(".js-root-path__input");
const fileListElem = dbxElem.querySelector(".js-file-list");
const organizeBtn = dbxElem.querySelector(".js-organize-btn");
const dateRangeElem = dbxElem.querySelector(".js-date-range");
const logElem = dbxElem.querySelector(".js-log");
...
const init = () => {
  dbx
    ...
    .then(async res => {
      ...
      dbxElem.classList.remove("hidden");
